...
// №1
// 1) получить машины черного или красного цвета
// 2) вывести только цвет машины
// 3) выводить значение только если оно отличается от предыдущего в потоке

// №2
// 1) пропустить первые 3 машины из потока
// 2) взять первые 5 машин из потока игнорируя все остальные

// №3
// 1) получить только машины синего цвета
// 2) вывести в консоль полученные машины
// 3) добавить задержку на испускание значений в 500мс

// №4
// 1) выводить только производителя машины
// 2) испускать значение только если в потоке не было активности в течении 500мс

// №5
// 1) вывести поток  (cars$ или trucks$), который первым начнет испускать значения


/* 

Здесь пишем свое решение
